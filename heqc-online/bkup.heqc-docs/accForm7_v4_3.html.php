...
<table width='95%' cellpadding='2' cellspacing='2' align='center' border='0'>
	...
	<BR>
	<tr>
	<td ALIGN=RIGHT valign="top" width="35%"><b>5.	Complete Table A and Table B in terms of the module structure of the programme / qualification: </b></td>
		
	<tr/>
	<tr>
		<BR>
		<td ALIGN=RIGHT valign="top" width="35%"><b>Table A: Compulsory modules (core and fundamental) </b></td>
		<BR/>
		<td colspan="2">
			...
			//	$dom = new DOMDocument();
				...
				array_push($dFields, "type__text|name__und_credits");

				//array_push($dFields, "type__text|name__course_type");
				//array_push($dFields, "$tcourse_type|name__course_type");
				array_push($dFields, "type__text|name__course_typ|value__".$tcourse_type);
				...
				$hFields = array("Module name", "NQF Level of the module", "No. of credits per module", "Year of study (1, 2, 3, 4)",  "Semester (1,2)");
	...
	<BR>
	<tr>
	<td ALIGN=RIGHT valign="top" width="35%"><b>Table B: Elective modules (if applicable)  </b></td>
		<BR>
	<tr/>
	<tr>
		
		
		<td ALIGN=RIGHT valign="top" width="35%"><b>If different streams: Upload document outlining electives per stream  </b></td>
		...
		<td colspan="2">
			...
			<?php
				...
				$hFields = array("Module name", "NQF Level of the module", "No. of credits per module", "Optional", "Year of study (1, 2, 3, 4)", "Semester (1,2)");
