...
<tr>
    <td colspan="2" class="loud">Capture Accreditation Status record<hr><br></td>
</tr>
<tr>
	<td width="50%"><b>Institution name:</b></td>
	<td><?php echo $this->showField("HEI_id");?></td>
</tr>

<?php

$this->formFields["HEI_id"]->fieldValue =ins_id
