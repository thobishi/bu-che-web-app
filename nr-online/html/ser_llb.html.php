...
<!-- <tr>
    ...
    <tr>
		...
		<td class="fieldsetData">
			...
			<?php 
				$this->makeLink("additional_doc1", "Prior Site Visit - Q1-3 of SER");
				$this->makeLink("additional_doc2", "Prior Site Visit - Q4 of SER");
				$this->makeLink("additional_doc3", "Prior Site Visit - Q5-8 and other support documents");
	...
	<tr>
		...
		<td class="fieldsetData">
			...
			<?php
				...
				$this->makeLink("uploadser_progress_report", "Upload Progress Report");
                $this->makeLink("uploadser_progress_report_1", "Upload Additional Progress Report");
                $this->makeLink("uploadser_progress_report_2", "Upload Additional Progress Report");
			?>
			</fieldset>
		</td>
	</tr>
