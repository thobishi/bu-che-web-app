...
<?php
	if(!empty($variables['reviewer'])){
		echo "Dear " . $variables['reviewer']['User']['first_name'] . ' ' . $variables['reviewer']['User']['last_name'] . "\n\n";
	}else{
		echo "Dear Colleague" . "\n\n";
	}
	echo "Please process the following programme(s) which have been assigned to you." . "\n";
	echo "You may access the programme information for the following programme(s) in the HEQSF-online Review Portal" . "\n\n";
	...
	echo "\nPlease note that the review is due by " . $variables['reviewDueDate'];
